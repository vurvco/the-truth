...
== Description ==
<a href="http://www.poorbuk.com/wordpress/jarim/libro-de-visitas/" >For live example click here!!!</a><br><br>
...
Is in SETTINGS-> LIBRO DE VISITAS
and also in
PLUGINS->LIBRO DE VISITAS(where you see all plugins)->SETTINGS
(a small menu under the name of the plugin, just beside Activate and Deactivate).
...
and also in<br>
PLUGINS->LIBRO DE VISITAS(where you see all plugins)->SETTINGS<br> (a small menu under the name of the plugin, just beside Activate and Deactivate).
...
= 1.4 =
* 2018-05-29
* Release stable and updated version 1.4 to the public.
...
== Upgrade Notice ==
= 1.4 =
Better pictures, colors, fonts and text details.  Recommended Upgrade :).

= 1.3 =
Change of colors, fonts and text details.  Recommended Upgrade :).
